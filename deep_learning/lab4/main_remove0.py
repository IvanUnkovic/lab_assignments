...
if __name__ == '__main__':
    ...
    ds_train_with_all_classes = MNISTMetricDataset(mnist_download_root, split='train')
    ...
    print(f"> Loaded {len(ds_train)} training images without class 0!")
    ...
    train_loader_with_all_classes = DataLoader(
        ds_train_with_all_classes,
        batch_size=64,
        shuffle=True,
        pin_memory=True,
        num_workers=4,
    ...
    epochs = 3
    saved_params_name = 'remove0_model.pth'
    ...
    for epoch in range(epochs):
        ...
        if EVAL_ON_TEST or EVAL_ON_TRAIN:
            ...
            representations = compute_representations(model, train_loader_with_all_classes, num_classes, emb_size, device)
    ...
    torch.save(model.state_dict(), saved_params_name)
