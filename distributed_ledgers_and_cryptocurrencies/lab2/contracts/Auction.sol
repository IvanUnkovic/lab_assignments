...
contract Auction {
    ...
    function finalize() public {
        ...
        require(highestBidderAddress != address(0)); //adress(0) je prazna adresa, znači da highest bidder address ne postoji

        if (judgeAddress != address(0)){ //ako postoji sudac
