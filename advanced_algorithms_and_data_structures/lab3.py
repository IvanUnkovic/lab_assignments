...
def red_uncle_case(
    ...
    if grandparent.parent and grandparent is grandparent.parent.left:
        is_left = True
    else:
        is_left = False
    tree.insert_rebalance(grandparent, not is_left)
...
def straight_case(
    ...
    if grandparent and parent is grandparent.left:
        is_left1 = True
    else:
        is_left1 = False
    if is_left1:
    ...
    if parent and node is parent.left:
        ...
        is_left2 = False
    tree.insert_rebalance(node, is_left2)
...
def broken_case(
    ...
    tree.insert_rebalance(parent, is_left)